<aside class="w-64 bg-slate-900 text-slate-300 h-screen flex flex-col justify-between border-r border-slate-800 shadow-xl select-none shrink-0 sticky top-0">
    <!-- Brand / Header -->
    <div class="p-6 border-b border-slate-800/60 bg-slate-950/30">
        <div class="flex items-center space-x-3">
            <div class="p-2.5 bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 text-emerald-400 rounded-xl border border-emerald-500/20 shadow-inner flex items-center justify-center shrink-0">
